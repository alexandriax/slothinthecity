...
export function TouchControls({ arboreal, prompt, promptKey, showPause = false, showSense = true, vehicle }: TouchControlsProps) {
  ...
  return <div className={`touch-ui ${expanded ? "expanded" : "collapsed"}`}>
    ...
    {expanded && <>
      ...
      {arboreal && <button className="touch-down" data-input-code="ControlLeft" aria-label="Descend safely toward ground" onPointerDown={(event) => { event.preventDefault(); emitKey("ControlLeft", true); emitKey("ControlLeft", false); }}>Down</button>}
