...
const DEBUG_DESTINATIONS: Array<{ scene: DebugSceneName; label: string; detail: string }> = [
  ...
  { scene: "bronx-gary-fed", label: "Fed Gary", detail: "Jam, climb-out and following" },
  ...
  { scene: "museum-gary-scooter", label: "Gary scooter", detail: "Sixth scooter and jam persistence" },
